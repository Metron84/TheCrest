...
/** Affinity + Character + Balance (pillar) + colour veto. */
export const QUIZ_STEP_COUNT = AFFINITY_COUNT + CHARACTER_COUNT + 2;
...
export const COLOR_Q = {
  q: "What is your least favourite colour?",
  lead: "That colour is out. We will not match you to a club that wears it.",
};

export const STORAGE_KEY = "crest-quiz-v3";
