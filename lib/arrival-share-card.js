...
export async function renderArrivalSharePng(club) {
  await Promise.all([
    loadFont("Bodoni Moda", "/fonts/bodoni-latin-400-normal.woff2"),
    loadFont("Bodoni Moda", "/fonts/bodoni-latin-600-italic.woff2"),
    loadFont("Archivo", "/fonts/archivo-latin-500-normal.woff2"),
    loadFont("Archivo", "/fonts/archivo-latin-400-normal.woff2"),
  ]);
