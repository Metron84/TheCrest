 ...
 * @param {number[]} [varianceW]
 */
export function rank(userVector, clubs, pillarWeights, varianceW, personCharacter = null) {
 ...
 * @param {(number|null)[]} scores
 */
export function rankPartial(scores, clubs, pillarWeights, varianceW, personCharacter = null) {
  const vw = varianceW ?? getVarianceWeights(clubs);
  return clubs
    .map((club) => ({
      club,
 ...
 * @param {number[]} varianceW
 */
export function pathFit(userVector, club, pillarWeights, varianceW, personCharacter = null) {
  return pathFitPartial(userVector, club, pillarWeights, varianceW, personCharacter);
}
 ...
 * @param {number[]} varianceW
 */
export function pathFitPartial(scores, club, pillarWeights, varianceW, personCharacter = null) {
  if (!varianceW) throw new Error("varianceW is required");
